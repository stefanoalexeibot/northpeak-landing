...
const stats = [
  ...
  { value: "4.9Γÿà", label: "satisfacci├│n promedio" },
];

const caseStudies = [
  {
    client: "El Mezquite",
    industry: "Restaurante ΓÇö San Pedro Garza Garc├¡a",
    headline: "De 180 a 2,100 seguidores en 5 meses",
    description:
      "Sin presencia real en Instagram. Con estrategia de Reels y contenido local logramos un crecimiento org├ínico sostenido y reservaciones r├⌐cord.",
  ...
  {
    client: "Cl├¡nica Dental Sonrisa Plus",
    industry: "Salud ΓÇö Monterrey Centro",
    headline: "De invisible a #2 en Google Maps",
    description:
      "Solo 8 rese├▒as y sin optimizaci├│n en Google. En 3 meses llegamos al top 3 en b├║squedas de dentistas en su zona y duplicamos citas semanales.",
    tags: ["Google Maps", "SEO Local", "Rese├▒as"],
    metrics: [
      { label: "Rese├▒as", value: "8 ΓåÆ 142" },
      { label: "Posici├│n Google", value: "#2" },
  ...
  },
  {
    ...
    industry: "Desarrolladora ΓÇö Nuevo Le├│n",
    ...
    tags: ["Meta Ads", "WhatsApp Business", "Segmentaci├│n"],
    metrics: [
...
const services = [
  ...
  },
  {
    ...
    includes: [
      ...
      "SEO local",
      "Fotos y actualizaci├│n",
      "Reportes de posici├│n",
    ],
    color: "text-blue-400",
    bg: "bg-blue-400/10",
  },
...
const steps = [
  {
    ...
    description:
      "Hacemos un diagn├│stico gratuito y honesto de tu situaci├│n actual: redes, Google Maps, sitio web y publicidad. Sin vender aire.",
    icon: BarChart2,
  },
  {
    number: "02",
    ...
    description:
      "Creamos un plan espec├¡fico para tu negocio, tu zona y tu competencia en Monterrey. No plantillas gen├⌐ricas.",
    icon: MapPin,
  },
  {
    number: "03",
    ...
    description:
      "Publicamos, lanzamos anuncios y gestionamos tu presencia. T├║ ves cada resultado desde tu portal en tiempo real.",
    icon: TrendingUp,
  },
];

// ΓöÇΓöÇ Page ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-northpeak-bg text-northpeak-text">
      ...
      <section className="relative overflow-hidden pt-20 pb-24 px-4 sm:px-6">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-northpeak-green/20 bg-northpeak-green/5 text-northpeak-green text-xs font-medium mb-8">
            ...
            Agencia de marketing digital ΓÇö Monterrey, N.L.
          </div>
          ...
          <p className="text-lg sm:text-xl text-northpeak-text-muted max-w-2xl mx-auto mb-10 leading-relaxed">
            Ayudamos a restaurantes, cl├¡nicas y negocios locales en Monterrey a ganar clientes
            por internet ΓÇö con estrategia, resultados medibles y sin vender humo.
          </p>
      ...
      <section className="py-20 px-4 sm:px-6 bg-northpeak-card border-y border-northpeak-surface">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-northpeak-text-muted max-w-xl mx-auto">
              Sin reuniones interminables ni procesos complicados. Empezamos a trabajar r├ípido.
            </p>
          </div>
      ...
      {/* ΓöÇΓöÇ Services / Pricing ΓöÇΓöÇ */}
      <section id="servicios" className="py-20 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-northpeak-text-muted max-w-xl mx-auto">
              Mostramos rangos de inversi├│n para que sepas con qu├⌐ esperar antes de hablar con nosotros.
            </p>
          </div>
                  ...
                  >
                    ...
                    <div className="flex gap-0.5">
                      {Array.from({ length: 5 }).map((_, i) => (
                        <Star
                          key={i}
                          className={`h-3.5 w-3.5 ${i < t.rating ? "text-yellow-400 fill-yellow-400" : "text-northpeak-surface fill-northpeak-surface"
                            }`}
                        />
                      ))}
                    </div>
      ...
      <section className="py-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-heading font-bold text-northpeak-text mb-4">
              ┬┐Cu├ínto podr├¡as ganar?
            </h2>
            <p className="text-northpeak-text-muted max-w-xl mx-auto">
              Ajusta los n├║meros de tu negocio y ve qu├⌐ retorno realista esperar con una inversi├│n
      ...
      <section className="py-24 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <p className="text-northpeak-text-muted text-lg mb-10 max-w-xl mx-auto">
            ...
            decimos exactamente en qu├⌐ mejorar.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex flex-col items-center sm:items-start gap-2">
              ...
              <div className="flex items-center gap-1 text-xs text-northpeak-text-dim">
                ...
                Monterrey, Nuevo Le├│n ΓÇö M├⌐xico
              </div>
            </div>
