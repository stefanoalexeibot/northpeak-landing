...
const ETAPA_LABELS: Record<string, { label: string; color: string; dot: string }> = {
  ...
  cuestionario_completado: { label: "Con cotizaci├│n", color: "text-emerald-400", dot: "bg-emerald-400" },
...
export default async function AdminDashboard() {
  // createClient para auth (respeta sesi├│n del usuario)
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-4 max-w-md text-center">
          ...
          <p className="text-sm text-northpeak-text-muted">
            No se pudieron obtener los datos. Verifica tu conexi├│n a Supabase.
          </p>
  ...
  return (
    <AdminDashboardClient>
      <div className="space-y-6">
        ...
        {/* Main KPIs ΓÇö 3 big cards */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {/* Revenue ΓÇö most important */}
